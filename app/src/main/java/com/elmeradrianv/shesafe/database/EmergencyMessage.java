...
public class EmergencyMessage extends ParseObject {
    ...
    public String getMessage(){return getString(MESSAGE_KEY);}
    public void setMessage(String message){put(MESSAGE_KEY,message);}
    public User getUser(){return (User) get(USER_KEY);}
    public JSONArray getEmergencyContacts(){return getJSONArray(EMERGENCY_CONTACTS_KEY);}
